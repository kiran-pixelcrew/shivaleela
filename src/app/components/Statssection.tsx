...
function Statssection() {
  return (
    <div className="mx-auto w-full max-w-full px-6 md:px-12 py-10 md:py-20 font-sans space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={index}
            className="text-left border rounded-lg h-fit space-y-5 py-8 px-6 flex flex-col bg-[#F4F5FF]"
          >
      ...
      <div className="text-justify text-gray-700 leading-loose font-medium text-lg md:text-xl">
      ...
      <div className="flex flex-col mt-10 md:mt-20 space-y-8">
        <span className="text-3xl md:text-5xl font-serif">
          Abhyasa - Kathak & Bharathantyam Classes
        </span>
        <p className="leading-loose text-base text-justify md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
          <div className="space-y-4">
            <div className="overflow-hidden rounded-lg">
              <Image src={Kathak} alt="Kathak" className="w-full h-auto" priority />
            </div>
          ...
          <div className="space-y-4">
            <div className="overflow-hidden rounded-lg">
              <Image src={Kathak} alt="Bharathanatyam" className="w-full h-auto" priority />
            </div>
            <span className="block font-medium">
